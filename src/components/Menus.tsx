...
function Menu1() {
  return (
    <Button active={true} onClick={() => onMenuOneClick()} className="py-2">
...
function Menu2() {
  return (
    <Button active={true} onClick={() => onMenuTwoClick()} className="py-2">
      <img className="menu-img" 
        src={aboutuslogo}
        alt="About Us" 
      />
